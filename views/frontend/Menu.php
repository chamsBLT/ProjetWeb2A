...
<body>
		...
		<div class="nav-wraper">
			<div class="navbar">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link active" href="menu.html"><img src="img/header/nav-icon3.png" alt="">menu</a></li>
	...
	<div class="site-main">
		...
		<!--================ Menu Area =================-->
		<div class="the-products" style="display: flex;justify-content: center;align-items: center;right: 200px;">
		  <iframe src="indexx.php" id="myiframe" style="height:900px;width:900px;border:none;"></iframe>
		</div>
		<!--================End Menu Area =================-->
